...
var ViewBuilderVisitor = (function () {
    ...
    ViewBuilderVisitor.prototype.visitEmbeddedTemplate = function (ast, parent) {
        ...
        var embeddedView = new CompileView(this.view.component, this.view.genConfig, this.view.pipeMetas, o.NULL_EXPR, this.view.animations, this.view.animationSummary, this.view.viewIndex + this.nestedViewCount, compileElement, templateVariableBindings);
