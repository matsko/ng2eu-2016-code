...
import { AnimationSummary, AnimationEntrySummary } from "../animation/animation_summary";
export declare class CompileView implements NameResolver {
    ...
    animationsSummaryMap: {
        [entryName: string]: AnimationEntrySummary;
    };
    constructor(component: CompileDirectiveMetadata, genConfig: CompilerConfig, pipeMetas: CompilePipeMetadata[], styles: o.Expression, animations: AnimationEntryCompileResult[], animationSummary: AnimationSummary, viewIndex: number, declarationElement: CompileElement, templateVariableBindings: string[][]);
