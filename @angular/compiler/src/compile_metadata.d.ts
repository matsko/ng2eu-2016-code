...
export declare class CompileAnimationQueryMetadata extends CompileAnimationMetadata {
    selector: any;
    config: any;
    animation: CompileAnimationMetadata[];
    constructor(selector: any, config: any, animation: CompileAnimationMetadata[]);
}
