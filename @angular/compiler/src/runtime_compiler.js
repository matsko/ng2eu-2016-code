...
import { generateAnimationSummary } from "./animation/animation_summary";
/**
...
export var RuntimeCompiler = (function () {
    ...
    RuntimeCompiler.prototype._compileTemplate = function (template) {
        ...
        var compileResult = this._viewCompiler.compileComponent(compMeta, parsedTemplate, ir.variable(stylesCompileResult.componentStylesheet.stylesVar), template.viewPipes, animationSummary, compiledAnimations);
        compileResult.dependencies.forEach(function (dep) {
            var depTemplate;
