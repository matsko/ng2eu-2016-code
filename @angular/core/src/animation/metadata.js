 ...
 */
export var AnimationQueryMetadata = (function (_super) {
    __extends(AnimationQueryMetadata, _super);
 ...
 */
export function _query(criteria, config, animation) {
    var steps = Array.isArray(animation)
        ? animation
        : [animation];
    return new AnimationQueryMetadata(criteria, config, steps);
}
export function query(criteria, animation) {
    return _query(criteria, {}, animation);
}
export function queryView(criteria, animation) {
