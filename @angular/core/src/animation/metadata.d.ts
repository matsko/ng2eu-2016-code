 ...
 */
export declare class AnimationQueryMetadata extends AnimationMetadata {
    selector: string;
    config: any;
    steps: AnimationMetadata[];
    constructor(selector: string, config: any, steps: AnimationMetadata[]);
}
/**
 ...
 */
export declare function _query(criteria: any, config: any, animation: AnimationMetadata | AnimationMetadata[]): AnimationQueryMetadata;
export declare function query(criteria: any, animation: AnimationMetadata | AnimationMetadata[]): AnimationQueryMetadata;
export declare function queryView(criteria: any, animation: AnimationMetadata | AnimationMetadata[]): AnimationQueryMetadata;
